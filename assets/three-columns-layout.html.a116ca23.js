...
<span class="token punctuation">}</span>
</code></pre></div>`,3),k={href:"https://codepen.io/cyio/pen/wvzzzdQ",target:"_blank",rel:"noopener noreferrer"},d=r("three column layout - flex");function g(h,_){const s=t("ExternalLinkIcon");return e(),p(c,null,[i,n("p",null,[n("a",k,[d,o(s)])])],64)}var x=a(u,[["render",g],["__file","three-columns-layout.html.vue"]]);export{x as default};
