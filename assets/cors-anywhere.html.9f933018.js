import{_ as e,e as n}from"./app.bacf2a9d.js";const a={},s=n(`<h1 id="cors-anywhere" tabindex="-1"><a class="header-anchor" href="#cors-anywhere" aria-hidden="true">#</a> cors-anywhere</h1><div class="language-text ext-text"><pre class="language-text"><code>git clone https://github.com/Rob--W/cors-anywhere.git
