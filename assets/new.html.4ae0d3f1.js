import{_ as t,r as o,o as e,c,a as n,b as a,F as l,e as k,d as p}from"./app.7a0e2e86.js";const u={},r=k(`<h2 id="new" tabindex="-1"><a class="header-anchor" href="#new" aria-hidden="true">#</a> new</h2><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">var</span> o <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre></div>`,10),i={href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Inheritance_and_the_prototype_chain",target:"_blank",rel:"noopener noreferrer"},d=p("Inheritance and the prototype chain - JavaScript | MDN"),m={href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/new",target:"_blank",rel:"noopener noreferrer"},y=p("new operator - JavaScript | MDN");function f(_,w){const s=o("ExternalLinkIcon");return e(),c(l,null,[r,n("p",null,[n("a",i,[d,a(s)]),n("a",m,[y,a(s)])])],64)}var h=t(u,[["render",f],["__file","new.html.vue"]]);export{h as default};
