import{_ as n,e as s}from"./app.0a28e50e.js";const a={},p=s(`<h1 id="once" tabindex="-1"><a class="header-anchor" href="#once" aria-hidden="true">#</a> once</h1><p>\u591A\u6B21\u8C03\u7528\uFF0C\u6267\u884C\u4E00\u6B21</p><p>\u5229\u7528\u95ED\u5305\uFF0C\u7F13\u50A8 flag \u548C result</p><ol><li>\u5DF2\u7ECF\u6267\u884C\u8FC7\uFF0C\u76F4\u63A5\u8FD4\u56DE result</li><li>\u5426\u5219\uFF0C\u6267\u884C\u5E76\u8FD4\u56DE result\uFF0C\u6807\u8BB0 flag</li></ol><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code>  <span class="token keyword">function</span> <span class="token function">once</span><span class="token punctuation">(</span><span class="token parameter">fn</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
