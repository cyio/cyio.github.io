import{_ as s,e as n}from"./app.7dbfe519.js";const a={},e=n(`<h1 id="babel-node-npm" tabindex="-1"><a class="header-anchor" href="#babel-node-npm" aria-hidden="true">#</a> Babel Node &amp;&amp; Npm</h1><ul><li>\u6CE8\u610F\u5B89\u88C5 babel-cli \uFF0C\u800C\u975E babel</li><li>\u8FD8\u6709\u4E2A babel-preset-es2015</li><li>\u65B0\u5EFA\u6587\u4EF6 .babelrc</li></ul><div class="language-text ext-text"><pre class="language-text"><code>{
