import{_ as n,e as s}from"./app.fcaad8ec.js";const a={},t=s(`<h1 id="proxy" tabindex="-1"><a class="header-anchor" href="#proxy" aria-hidden="true">#</a> Proxy</h1><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">const</span> target <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>\u4F7F\u7528\u573A\u666F\uFF1A</p><ul><li>set \u65F6\u505A\u6570\u636E\u6821\u9A8C</li><li>key \u4E0D\u5B58\u5728\u65F6\uFF0C\u63D0\u4F9B\u9ED8\u8BA4\u503C</li></ul>`,4);function p(o,e){return t}var l=n(a,[["render",p],["__file","ES6-proxy.html.vue"]]);export{l as default};
